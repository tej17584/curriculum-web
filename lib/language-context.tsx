...
const translations: Translations = {
  ...
  chapterExperience: { en: "Chapter II: Experience", es: "Capítulo II: Experiencia" },
  chapterProjects: { en: "Chapter III: Featured Projects", es: "Capítulo III: Proyectos Destacados" },
  chapterSkills: { en: "Chapter IV: Skills & Technologies", es: "Capítulo IV: Habilidades y Tecnologías" },
  ...
  programmingLanguages: { en: "Programming Languages", es: "Lenguajes de Programación" },
  ...
  advanced: { en: "Full Professional Proficiency", es: "Dominio Profesional Completo" },
