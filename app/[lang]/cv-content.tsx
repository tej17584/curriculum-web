...
export default function CVContent({ dict, lang }: CVContentProps) {
  ...
  // Simple translation function from dict
  const t = (key: string) => {
  ...
  return (
    <div className='bg-background from-background via-background to-muted/20 overflow-x-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))]'>
      <div
        ref={containerRef}
        className='hide-scrollbar relative mx-auto [max-height:calc(100vh-100px)] max-w-4xl overflow-x-hidden overflow-y-auto px-4 py-8 pb-32 sm:px-6 sm:py-12 lg:px-8 lg:py-16'
      >
        {/* Page 1: About */}
